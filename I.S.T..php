                    ...
                    <div class="doctor">
                        ...
                        <div class="doctor-info">
                            ...
                            <div class="actions">
                                ...
                                <a href="Votre_Compte.html?id=<?= $specialiste->id ?>&nom=<?= urlencode($specialiste->prenom . ' ' . $specialiste->nom) ?>&specialite=<?= urlencode($specialiste->specialite) ?>" class="btn">Prendre Rendez-vous</a>
                                <a href="Votre_Compte.html?id=<?= $specialiste->id ?>&nom=<?= urlencode($specialiste->prenom . ' ' . $specialiste->nom) ?>&specialite=<?= urlencode($specialiste->specialite) ?>" class="btn">Chattez</a>
                            </div>
